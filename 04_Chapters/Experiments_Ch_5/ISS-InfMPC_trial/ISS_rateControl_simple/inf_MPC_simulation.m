...
xdot_nom = xdot_nom(u(1),u(2),u(3),x(1),x(2),x(3));

% dynamics
xdot = x_dot(u(1),u(2),u(3),w(1),w(2),w(3),x(1),x(2),x(3));
...
for j = 1:numRuns
    ...
    for k = 2:simTime/simStepSize
        ...
        suffCon(k-1) = full(suffCon_fun(x_sim(:,k),u_sol,w0(k)));
