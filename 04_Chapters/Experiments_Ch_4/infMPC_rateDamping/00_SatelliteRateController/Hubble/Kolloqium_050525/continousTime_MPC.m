...
function [results] =continousTime_MPC
...
P = 11175*x(1)^2 + 99922.4*x(2)^2 + 103402*x(3)^2;
...
results.tEnd_all_cont = tEnd_all;
results.x_sol_all_cont = x_sol_all;
results.t_cont          = t;
results.u_sol_all_cont = u_sol_all;
end
