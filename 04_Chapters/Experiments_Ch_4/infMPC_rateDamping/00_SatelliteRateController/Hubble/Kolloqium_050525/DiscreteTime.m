...
for runIdx = 1:numRuns
    x0_low =  [0.0254;-0.0015; 0];%(max_rate -min_rate ).*rand(3,1) + min_rate ;
...
results.tEnd_all_disc = all_tEnd_allRuns;
results.u_sol_all_disc=      all_u_sol_vec;
results.x_sol_all_    =    all_x_sim;
results.t_disc = t;
end
