...
V =  -0.9 + 1.39668e+14*x(1)^4 - 429.078*x(1)^3*x(2) + 6.00513e+07*x(1)^2*x(2)^2 ...
  - 16.5973*x(1)*x(2)^3 + 1.39668e+14*x(2)^4 + 84.7267*x(1)^3*x(3) - 16.8773 ...
  *x(1)^2*x(2)*x(3) - 73.1365*x(1)*x(2)^2*x(3) - 426.211*x(2)^3*x(3) + 6.66981e+07 ...
  *x(1)^2*x(3)^2 + 150.876*x(1)*x(2)*x(3)^2 + 6.6758e+07*x(2)^2*x(3)^2 - 10.1583 ...
  *x(1)*x(3)^3 - 74.8082*x(2)*x(3)^3 + 1.39668e+14*x(3)^4;
...
omegaMax1 = 0.5/60*pi/180;
omegaMax2 =  0.9/60*pi/180;
omegaMax3 =  0/60*pi/180;
...
Phi = Function('f',...       
            {x},...     
            {   2.29125e+06*x(1)^2 - 0.00723708*x(1)*x(2) + 2.29163e+06*x(2)^2 - 0.000118896 ...
  *x(1)*x(3) + 1.1068e-05*x(2)*x(3) + 5.69598e+06*x(3)^2});   % dt = T/N, k = 1 ( first discrete step) 
