...
A0 = full(casos.PD(subs(nabla(f,x),[x;u],[x_0;u_0])));
B0 = full(casos.PD(subs(nabla(f,u),[x;u],[x_0;u_0])));
...
Wsol_re_shift = subs(Wsol_re,x, x+x_0);
% g_shift = subs(Wsol_re,x, x+x_0);
figure(1)
deg2rad = diag([pi/180,pi/180,pi/180 1 1 1]);
clf
pcontour(Wsol_re_shift,0,[-1 1 -1 1],'g')
hold on 
